...
object EdDSANamedCurveTable {
    ...
    private val ed25519curve = Curve(ED_25519_FINITE_FIELD,
    ...
    private val ed25519 = EdDSANamedCurveSpec(
            ED_25519,
            ed25519curve,
            "SHA-512", // H
            Ed25519ScalarOps(), // l
    ...
    private val curves = LinkedHashMap<String, EdDSANamedCurveSpec>()

    private fun defineCurve(curve: EdDSANamedCurveSpec) {
        curves[curve.name.toLowerCase(Locale.ENGLISH)] = curve
    }

    internal fun defineCurveAlias(name: String, alias: String) {
        val curve = curves[name.toLowerCase(Locale.ENGLISH)] ?: throw IllegalStateException()
        curves[alias.toLowerCase(Locale.ENGLISH)] = curve
    }
