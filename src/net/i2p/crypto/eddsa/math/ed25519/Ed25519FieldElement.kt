 ...
 */
(f: FiniteField, t: IntArray) : FieldElement(f) {
    /**
     ...
     * Preconditions:
     *
     *  * $|field|$ bounded by $1.1*2^{25},1.1*2^{24},1.1*2^{25},1.1*2^{24},$ etc.
     ...
     * Preconditions:
     *
     *  * $|field|$ bounded by $1.65*2^{26},1.65*2^{25},1.65*2^{26},1.65*2^{25},$ etc.
     *
     *
     * Postconditions:
     *
    ...
    override fun cmov(`val`: FieldElement, b: Int): FieldElement {
        ...
        result[0] = t[0] xor (t[0] xor that.t[0] and -b)
        result[1] = t[1] xor (t[1] xor that.t[1] and -b)
        result[2] = t[2] xor (t[2] xor that.t[2] and -b)
        result[3] = t[3] xor (t[3] xor that.t[3] and -b)
        result[4] = t[4] xor (t[4] xor that.t[4] and -b)
        result[5] = t[5] xor (t[5] xor that.t[5] and -b)
        result[6] = t[6] xor (t[6] xor that.t[6] and -b)
        result[7] = t[7] xor (t[7] xor that.t[7] and -b)
        result[8] = t[8] xor (t[8] xor that.t[8] and -b)
        result[9] = t[9] xor (t[9] xor that.t[9] and -b)
        return Ed25519FieldElement(f, result)
    }
