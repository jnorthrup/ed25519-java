...
class MyEmptyEncoding(private val ed25519LittleEndianEncoding: Ed25519LittleEndianEncoding) : EmptyEncoding() {
    ...
    override fun decode(`in`: ByteArray): FieldElement {
        ...
        h[8] = h8.toInt()
        h[9] = h9.toInt()
        return Ed25519FieldElement(this!!.edDSAFiniteField!!, h)
    }
    ...
    override fun isNegative(x: FieldElement): Boolean {
        val s = ed25519LittleEndianEncoding.emptyEncoding.encode(x)
        return 0 != s[0]as Int and 1
    }
}
