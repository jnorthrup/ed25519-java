...
class MyEmptyEncoding extends EmptyEncoding {
    ...
    public FieldElement decode(@NotNull final byte[] in) {
        ...
        long h3 = (long) (Ed25519LittleEndianEncoding.load_3(in, 10) << 3);
        long h4 = (long) (Ed25519LittleEndianEncoding.load_3(in, 13) << 2);
        long h5 = Ed25519LittleEndianEncoding.load_4(in, 16);
        long h6 = (long) (Ed25519LittleEndianEncoding.load_3(in, 20) << 7);
        long h7 = (long) (Ed25519LittleEndianEncoding.load_3(in, 23) << 5);
        long h8 = (long) (Ed25519LittleEndianEncoding.load_3(in, 26) << 4);
        long h9 = (long) ((Ed25519LittleEndianEncoding.load_3(in, 29) & 0x7FFFFF) << 2);
        final long carry0;
        final long carry1;
        final long carry2;
        final long carry3;
