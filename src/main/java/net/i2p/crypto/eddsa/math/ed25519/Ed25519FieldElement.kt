 ...
 *
 * @param edDSAFiniteField The underlying field, must be the finite field with $p = 2^{255} - 19$ elements
 * @param t The $2^{25.5}$ bit representation of the field element.
 */
(edDSAFiniteField: EdDSAFiniteField?, t: IntArray) : BaseFieldElement(edDSAFiniteField) {
    /**
    ...
    init {
        assert(10 == t.size) { "Invalid radix-2^51 representation" }
        this.t = t.clone()
    }
     ...
     * Preconditions:
     *
     *  * $|edDSAFiniteField|$ bounded by $1.1*2^{25},1.1*2^{24},1.1*2^{25},1.1*2^{24},$ etc.
    ...
    override fun add(element: FieldElement): FieldElement {
        val g = (element as Ed25519FieldElement).t
        val h = IntArray(10)
        h[0] = t[0] + g[0]
        h[1] = t[1] + g[1]
        h[2] = t[2] + g[2]
        ...
        h[8] = t[8] + g[8]
        h[9] = t[9] + g[9]
        return Ed25519FieldElement(edDSAFiniteField, h)
    }
    ...
    override fun subtract(fieldElement: FieldElement): FieldElement {
        val g = (fieldElement as Ed25519FieldElement).t
        val h = IntArray(10)
        h[0] = t[0] - g[0]
        h[1] = t[1] - g[1]
        h[2] = t[2] - g[2]
    ...
    override fun multiply(fieldElement: FieldElement): FieldElement {
        ...
        val f1g1_2 = f1_2.toLong() * g[1].toLong()
        val f1g2 = t[1] * g[2].toLong()
        val f1g3_2 = f1_2.toLong() * g[3].toLong()
        val f1g4 = t[1] * g[4].toLong()
        val f1g5_2 = f1_2.toLong() * g[5].toLong()
        val f1g6 = t[1] * g[6].toLong()
        val f1g7_2 = f1_2.toLong() * g[7].toLong()
        val f1g8 = t[1] * g[8].toLong()
        val f1g9_38 = f1_2.toLong() * g9_19.toLong()
        ...
        val f3g1_2 = f3_2.toLong() * g[1].toLong()
        val f3g2 = t[3] * g[2].toLong()
        val f3g3_2 = f3_2.toLong() * g[3].toLong()
        val f3g4 = t[3] * g[4].toLong()
        val f3g5_2 = f3_2.toLong() * g[5].toLong()
        val f3g6 = t[3] * g[6].toLong()
        val f3g7_38 = f3_2.toLong() * g7_19.toLong()
        val f3g8_19 = t[3] * g8_19.toLong()
        val f3g9_38 = f3_2.toLong() * g9_19.toLong()
        ...
        val f5g1_2 = f5_2.toLong() * g[1].toLong()
        val f5g2 = t[5] * g[2].toLong()
        val f5g3_2 = f5_2.toLong() * g[3].toLong()
        val f5g4 = t[5] * g[4].toLong()
        val f5g5_38 = f5_2.toLong() * g5_19.toLong()
        val f5g6_19 = t[5] * g6_19.toLong()
        val f5g7_38 = f5_2.toLong() * g7_19.toLong()
        val f5g8_19 = t[5] * g8_19.toLong()
        val f5g9_38 = f5_2.toLong() * g9_19.toLong()
        ...
        val f7g1_2 = f7_2.toLong() * g[1].toLong()
        val f7g2 = t[7] * g[2].toLong()
        val f7g3_38 = f7_2.toLong() * g3_19.toLong()
        val f7g4_19 = t[7] * g4_19.toLong()
        val f7g5_38 = f7_2.toLong() * g5_19.toLong()
        val f7g6_19 = t[7] * g6_19.toLong()
        val f7g7_38 = f7_2.toLong() * g7_19.toLong()
        val f7g8_19 = t[7] * g8_19.toLong()
        val f7g9_38 = f7_2.toLong() * g9_19.toLong()
        ...
        val f9g1_38 = f9_2.toLong() * g1_19.toLong()
        val f9g2_19 = t[9] * g2_19.toLong()
        val f9g3_38 = f9_2.toLong() * g3_19.toLong()
        val f9g4_19 = t[9] * g4_19.toLong()
        val f9g5_38 = f9_2.toLong() * g5_19.toLong()
        val f9g6_19 = t[9] * g6_19.toLong()
        val f9g7_38 = f9_2.toLong() * g7_19.toLong()
        val f9g8_19 = t[9] * g8_19.toLong()
        val f9g9_38 = f9_2.toLong() * g9_19.toLong()
     ...
     * Preconditions:
     *
     *  * $|edDSAFiniteField|$ bounded by $1.65*2^{26},1.65*2^{25},1.65*2^{26},1.65*2^{25},$ etc.
     *
     *
     * Postconditions:
     *
    ...
    override fun square(): FieldElement {
        ...
        val f0f0 = f0.toLong() * f0.toLong()
        val f0f1_2 = f0_2.toLong() * f1.toLong()
        val f0f2_2 = f0_2.toLong() * f2.toLong()
        val f0f3_2 = f0_2.toLong() * f3.toLong()
        val f0f4_2 = f0_2.toLong() * f4.toLong()
        val f0f5_2 = f0_2.toLong() * f5.toLong()
        val f0f6_2 = f0_2.toLong() * f6.toLong()
        val f0f7_2 = f0_2.toLong() * f7.toLong()
        val f0f8_2 = f0_2.toLong() * f8.toLong()
        val f0f9_2 = f0_2.toLong() * f9.toLong()
        val f1f1_2 = f1_2.toLong() * f1.toLong()
        val f1f2_2 = f1_2.toLong() * f2.toLong()
        val f1f3_4 = f1_2.toLong() * f3_2.toLong()
        val f1f4_2 = f1_2.toLong() * f4.toLong()
        val f1f5_4 = f1_2.toLong() * f5_2.toLong()
        val f1f6_2 = f1_2.toLong() * f6.toLong()
        val f1f7_4 = f1_2.toLong() * f7_2.toLong()
        val f1f8_2 = f1_2.toLong() * f8.toLong()
        val f1f9_76 = f1_2.toLong() * f9_38.toLong()
        val f2f2 = f2.toLong() * f2.toLong()
        val f2f3_2 = f2_2.toLong() * f3.toLong()
        val f2f4_2 = f2_2.toLong() * f4.toLong()
        val f2f5_2 = f2_2.toLong() * f5.toLong()
        val f2f6_2 = f2_2.toLong() * f6.toLong()
        val f2f7_2 = f2_2.toLong() * f7.toLong()
        val f2f8_38 = f2_2.toLong() * f8_19.toLong()
        val f2f9_38 = f2.toLong() * f9_38.toLong()
        val f3f3_2 = f3_2.toLong() * f3.toLong()
        val f3f4_2 = f3_2.toLong() * f4.toLong()
        val f3f5_4 = f3_2.toLong() * f5_2.toLong()
        val f3f6_2 = f3_2.toLong() * f6.toLong()
        val f3f7_76 = f3_2.toLong() * f7_38.toLong()
        val f3f8_38 = f3_2.toLong() * f8_19.toLong()
        val f3f9_76 = f3_2.toLong() * f9_38.toLong()
        val f4f4 = f4.toLong() * f4.toLong()
        val f4f5_2 = f4_2.toLong() * f5.toLong()
        val f4f6_38 = f4_2.toLong() * f6_19.toLong()
        val f4f7_38 = f4.toLong() * f7_38.toLong()
        val f4f8_38 = f4_2.toLong() * f8_19.toLong()
        val f4f9_38 = f4.toLong() * f9_38.toLong()
        val f5f5_38 = f5.toLong() * f5_38.toLong()
        val f5f6_38 = f5_2.toLong() * f6_19.toLong()
        val f5f7_76 = f5_2.toLong() * f7_38.toLong()
        val f5f8_38 = f5_2.toLong() * f8_19.toLong()
        val f5f9_76 = f5_2.toLong() * f9_38.toLong()
        val f6f6_19 = f6.toLong() * f6_19.toLong()
        val f6f7_38 = f6.toLong() * f7_38.toLong()
        val f6f8_38 = f6_2.toLong() * f8_19.toLong()
        val f6f9_38 = f6.toLong() * f9_38.toLong()
        val f7f7_38 = f7.toLong() * f7_38.toLong()
        val f7f8_38 = f7_2.toLong() * f8_19.toLong()
        val f7f9_76 = f7_2.toLong() * f9_38.toLong()
        val f8f8_19 = f8.toLong() * f8_19.toLong()
        val f8f9_38 = f8.toLong() * f9_38.toLong()
        val f9f9_38 = f9.toLong() * f9_38.toLong()
    ...
    override fun cmov(fieldElement: FieldElement, b: Int): FieldElement {
        val that = fieldElement as Ed25519FieldElement
        val b1 = -b
        ...
        return Ed25519FieldElement(this.edDSAFiniteField, result)
    }
    ...
    override fun equals(obj: Any?): Boolean {
        if (obj !is Ed25519FieldElement)
            return false
        val fe = obj as Ed25519FieldElement?
