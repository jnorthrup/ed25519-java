...
class UtilsTest {
    ...
    fun equalsReturnsZeroForUnequalByteArrays() {
        ...
        while (32 > i) {
            System.arraycopy(bytes1, 0, bytes2, 0, 32)
            bytes2[i] = (bytes2[i] xor 0xff).toByte()
    ...
    companion object {
        ...
        private val bytes1 = byteArrayOf(59, 106, 39, -68, -50, -74, -92, 45, 98, -93, -88, -48, 42, 111, 13, 115, 101, 50, 21, 119, 29, -30, 67, -90, 58, -64, 72, -95, -117, 89, -38, 41)
        private val bytes2 = byteArrayOf(71, -93, -11, -73, 20, -108, -68, -39, 97, -13, -92, -24, 89, -94, 56, -42, -22, -8, -26, 72, 116, 109, 47, 86, -88, -101, 94, 35, 111, -104, -44, 95)
        private val bytes3 = byteArrayOf(95, -45, -106, -28, -94, -75, -36, -112, 120, -11, 126, 58, -75, -88, 124, 40, -3, 18, -114, 95, 120, -52, 74, -105, -12, 18, 45, -60, 95, 110, 75, -71)
    }
}
