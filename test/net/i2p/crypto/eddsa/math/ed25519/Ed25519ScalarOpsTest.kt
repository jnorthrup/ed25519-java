...
class Ed25519ScalarOpsTest {
    ...
    fun reduceReturnsExpectedResult() {
        ...
        while (1000 > i) {
            ...
            // Assert:
            assertThat(MathUtils.toBigInteger(reduced1).compareTo(MathUtils.groupOrder), IsEqual.equalTo(-1))
            assertThat(MathUtils.toBigInteger(reduced1).compareTo(BigInteger("-1")), IsEqual.equalTo(1))
    ...
    fun multiplyAndAddReturnsExpectedResult() {
        ...
        while (1000 > i) {
            ...
            // Assert:
            assertThat(MathUtils.toBigInteger(result1).compareTo(MathUtils.groupOrder), IsEqual.equalTo(-1))
            assertThat(MathUtils.toBigInteger(result1).compareTo(BigInteger("-1")), IsEqual.equalTo(1))
